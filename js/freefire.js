        ...
        <div class="pantallaJuego">
            ...
            <div class="menu-juego">
                ...
                <div class="modo-card">
                    <h3>☠️ Oscuro</h3>
                    <p>Estilo dark.</p>
                    <span class="cantidad-nombres">${categorias.oscuro.length} nombres</span>
                ...
                <div class="modo-card">
                    ...
                    <span class="cantidad-nombres">${categorias.parejas.length} nombres</span>
                ...
                <div class="modo-card">
                    ...
                    <span class="cantidad-nombres">${categorias.pro.length} nombres</span>
                ...
                <div class="modo-card">
                    ...
                    <span class="cantidad-nombres">${categorias.invisible.length} nombres</span>
